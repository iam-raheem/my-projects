...
class FlatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create flat" do
    assert_difference('Flat.count') do
      post flats_url, params: { flat: { agreement_amount: @flat.agreement_amount, area: @flat.area, base_price: @flat.base_price, date_of_booking: @flat.date_of_booking } }
    end
  ...
  test "should update flat" do
    patch flat_url(@flat), params: { flat: { agreement_amount: @flat.agreement_amount, area: @flat.area, base_price: @flat.base_price, date_of_booking: @flat.date_of_booking } }
